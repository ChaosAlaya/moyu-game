  ...
  var GUIDE_PAGES = [
    {
      ...
      html: '<p>爬 <b>10 层楼</b>，每层 <b>5 步</b>，打穿第 10 层 BOSS 即通关！</p>' +
        ...
        '<p>标题页「<b>📅 每日挑战</b>」：所有玩家同一天同一局，每天一个随机词条，比比谁爬得高。</p>'
    },
    {
      title: '战斗基础',
    ...
    },
    {
      ...
      html: '<p><b>小怪</b> / <b>精英</b>（更强但掉圣物）/ <b>事件</b>（各种梗与抉择）</p>' +
        '<p><b>秦国小卖铺</b>：买牌买圣物 + 付费删牌 + 付费复制牌（各 1 次；复制为基础版）</p>' +
        '<p><b>茶水间</b>：回复 30% 精力 或 升级 1 张牌（数值 +30%）</p>' +
        '<p><b>圣物</b>：最多同时装备 4 件，点击顶栏圣物图标可随时换装（只有装备的生效）。</p>' +
        '<p>每层第 1 步必为小怪，BOSS 前必有休整位（茶水间/事件/商店/精英随机）；最后一步固定 BOSS，打完上楼。</p>'
    },
    {
      title: '角色与被动',
